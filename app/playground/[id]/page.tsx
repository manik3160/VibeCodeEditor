...
import { PlaygroundEditor, type FileSystemItem } from "@/features/playground/components/playground-editor";
...
const MainPlaygroundPage: React.FC = () => {
  ...
  const {
    ...
    instance,
    writeFileSync,
    // @ts-expect-error - WebContainer types not fully defined
                ...
                <div className="flex-1">
                  ...
                  >
                    <ResizablePanel defaultSize={isPreviewVisible ? 50 : 100}>
                      <PlaygroundEditor
                        templateData={templateData as unknown as FileSystemItem} 
